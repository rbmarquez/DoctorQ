-- ====================================================================
-- SEED MARKETPLACE MOCK DATA FOR INOVAIA (CORRECTED)
-- ====================================================================
...
('88018888-8888-8888-8888-888888888888', '88888888-8888-8888-8888-888888888888', 'b2222222-2222-2222-2222-222222222222', '00000000-0000-0000-0000-000000000001', NULL, '{"subject": "Geografia", "grade_level": "fundamental"}'::jsonb, true, NOW() - INTERVAL '1 day'),
('88028888-8888-8888-8888-888888888888', '88888888-8888-8888-8888-888888888888', 'b3333333-3333-3333-3333-333333333333', '00000000-0000-0000-0000-000000000001', NULL, '{"subject": "Espanhol", "grade_level": "médio"}'::jsonb, true, NOW() - INTERVAL '6 hours');
...
-- ====================================================================
-- 6. INSTALACOES_MARKETPLACE - Only 1 record (unique constraint per marketplace_agente/empresa)
-- ====================================================================
...
-- Installation: InovaIA agent installed by company
(
    '11111111-1111-1111-1111-111111111111',
