...
from sqlalchemy import Boolean, CHAR, Column, DateTime, ForeignKey, Integer, String, func
...
class User(Base):
    ...
    nr_total_logins = Column(
        Integer, nullable=False, server_default=text("0"), name="nr_total_logins"
    )
    dt_criacao = Column(
        DateTime,
        nullable=False,
    ...
    favoritos = relationship("TbFavoritos", back_populates="user", lazy="select", cascade="all, delete-orphan")
