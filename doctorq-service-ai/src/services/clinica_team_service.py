...
from src.models import Perfil  # ✅ Importa através de __init__.py
from src.models import User  # ✅ Importa através de __init__.py
...
class ClinicaTeamService:
    ...
    async def criar_usuario_equipe(
        ...
        try:
            ...
            if not senha:
                # Gerar senha temporária: Estetiq + 6 dígitos aleatórios
                senha_temp = f"Estetiq{uuid.uuid4().hex[:6].upper()}"
                senha = senha_temp
            ...
            try:
                ...
                if empresa:
                    ...
                    senha_para_envio = senha if 'Estetiq' in senha else None
