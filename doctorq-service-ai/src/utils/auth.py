...
from src.models import User  # ✅ Importa através de __init__.py para ordem correta
...
# auto_error=False permite que endpoints funcionem sem autenticação quando usam get_current_apikey_optional
